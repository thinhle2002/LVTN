...
@section('body')
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('voucher.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="code" id="code"
                                        placeholder="Mã khuyến mãi (VD: WINTER2025)" type="text" class="form-control" value="{{ old('code') }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select required name="type" id="type" class="form-control">
                                        ...
                                        <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Giảm theo phần trăm (%)</option>
                                        <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>Giảm giá trị tiền cố định (VNĐ)</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <div class="input-group">
                                        <input required name="reduce" id="reduce"
                                            ...
                                            class="form-control" value="{{ old('reduce') }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="qty" id="qty"
                                        placeholder="Nhập số lượng code" type="number" min="1" class="form-control" value="{{ old('qty') }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="start_date" id="start_date"
                                        type="date" class="form-control" value="{{ old('start_date') }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="end_date" id="end_date"
                                        type="date" class="form-control" value="{{ old('end_date') }}">
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Khởi tạo lần đầu (cho trường hợp old() value)
            updateReduceField();

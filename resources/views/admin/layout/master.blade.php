                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            {{-- <img width="42" class="rounded-circle" src="./dashboard/assets/images/avatars/3.jpg"
                                                alt=""> --}}
                                            <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                        </a>
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                            class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right" style="background:transparent;border:0;padding-bottom:0;">
                                            <div class="dropdown-menu-header">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left">
                                                                    ...
                                                                    <div class="widget-subheading opacity-8">Quản trị viên</div>
                                                                </div>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="./admin/voucher" class="{{ request()->segment(2) == 'voucher' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Mã khuyến mãi
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <li class="mm-active">
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-plugin"></i>Thống kê doanh thu
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="./admin/revenue" class="{{ request()->segment(2) == 'revenuedays' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Doanh thu sản phẩm
                                        </a>
                                    </li>

...
@section('body')
<script>
    const COLOR_MAP = @json(config('convertColor.colors'));
    function convertColorNameJS(rawColor) {
        if (!rawColor) return '';
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="pd-desc">
                                    ...
                                    <h4>{{ number_format($product->discount * 1000, 0, ',', '.') }}đ <span>{{ number_format($product->price * 1000, 0, ',', '.') }}đ</span></h4>
                                    @else
                                        <h4>{{ number_format($product->price * 1000, 0, ',', '.') }}đ</h4>
                                    @endif
                                </div>
    ...
    <!-- Product Shop Session End -->

    <!-- Related Products Session Begin -->
